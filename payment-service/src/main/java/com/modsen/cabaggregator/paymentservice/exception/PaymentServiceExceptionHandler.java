...
import com.modsen.cabaggregator.paymentservice.dto.ErrorResponse;
...
public class PaymentServiceExceptionHandler {
    ...
    @ExceptionHandler(PaymentServiceGlobalException.class)
    public ResponseEntity<ErrorResponse> handleGlobalException(PaymentServiceGlobalException ex) {
